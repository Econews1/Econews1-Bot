...
# (Full glossary unchanged – included in actual code)
ECONOMIC_GLOSSARY = {
...
# (chart functions unchanged – see full code above for complete implementation)
...
def normalize_title(title):
    """Lowercase, remove punctuation, remove stopwords, return set of tokens."""
    text = title.lower()
...
def titles_are_similar(title1, title2, threshold=0.55):
    """Jaccard similarity between two normalized titles."""
...
def collect_news():
    ...
    # Limit posted_titles to last 200 to avoid file growth
